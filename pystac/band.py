...
class Band:
    ...
    owner: Asset | Item | Collection | None
    """The :class:`~pystac.Asset` or :class:`~pystac.ItemAsset` that this asset belongs
    ...
    def __init__(
        ...
        # Usually the Asset but can be the Item or the collection
        self.owner = None
